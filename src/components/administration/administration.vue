    ...
    <div class="admin">
      <div class="content_wrapper">
        <div class="content_left">
          <ul class="list" v-for="item in courses">
            <li class="item" :class="{'active':selectType === item.index}">
              <router-link to="" @click="">{{item.value}}</router-link>
              <ul>
                <li v-for="item in item.stage" @click="log(item.index)" class="courseStage">{{item.value}}</li>
              </ul>
            </li>
          </ul>
        </div>
        <div class="content_right">
          <div class="common_nav">
            <ul class="common_left">
              <li @click="type(item.id)" class="common_item" :class="{'active':courseType === item.id}" v-for="item in nav_list">
