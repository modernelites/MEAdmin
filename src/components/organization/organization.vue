...
<script>
  ...
  export default {
    ...
    methods: {
      Org_List: function () {
        this.$http.get(this.ApiUrl + "/me/Organization/Organization_List").then(response => {
      ...
      Org_Edit: function () {
        ...
        this.$http.post(this.ApiUrl + "/me/Organization/Organization_Edit", this.Org).then(response => {
          this.Org_List();
        }, response => {
          // error callback
        })
      ...
      Org_Del: function (m) {
        ...
        obj.$layer.confirm("确定他要删除吗?", function () {
          obj.$http.post(obj.ApiUrl + '/me/Organization/Organization_Del', m).then(res => {
            obj.Org_List();
            obj.$layer.closeAll();
          }, res => {
